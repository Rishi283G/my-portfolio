  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, i) => (
      <svg
        key={i}
        className={`w-5 h-5 ${
          i < rating ? "text-purple-500" : "text-gray-400 dark:text-gray-700"
        }`}
        fill="currentColor"
        viewBox="0 0 20 20"
      >
          ...
          >
            ...
            >
              ...
              <div className="relative">
                <svg
                  className="text-purple-600 w-10 h-10 opacity-20 absolute -top-6 -left-2"
                  fill="currentColor"
                  viewBox="0 0 32 32"
                >
                ...
                <svg
                  className="text-purple-600 w-10 h-10 opacity-20 absolute -bottom-6 -right-2"
                  fill="currentColor"
                  viewBox="0 0 32 32"
                >
